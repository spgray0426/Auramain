...
/*
 * ExecCalc_Damage.cpp
 * 데미지 계산 Execution Calculation 구현
 *
 * GAS의 핵심 데미지 계산 로직입니다:
 * - 속성 저항 (화염, 번개, 비전, 물리)
 * - 방어력과 방어 관통
 * - 블록 (데미지 50% 감소)
 * - 크리티컬 히트 (2배 + 보너스 데미지)
...
/**
 * 데미지 계산용 속성 캡처 정의 구조체
 * 방어력, 방어 관통, 블록 확률, 크리티컬, 저항 등
 */
...
/**
 * 디버프 적용 판정
 * 데미지 타입별로 디버프 확률을 계산하고 성공 시 컨텍스트에 정보 저장
 */
